...
Chapter 11 showed `SimpleDirectoryReader("../data").load_data()` and moved on. It is worth going a little deeper, because for 90% of "load some files from disk" use cases, this single class is the right answer.
...
Chapter 13 covers the other end of the ingestion story: given a corpus of Nodes, which index type should you actually build?
