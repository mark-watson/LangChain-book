...
When I wrote the first edition of this book it was difficult to run LLMs locally on my own computers. Now, in 2026, I can use Ollama to run very useful models on the old M1 8G MacBook I am writing this on:
