...
3. A single Python script that iterates the cases, runs each one through your pipeline, computes a match (exact, substring, LLM-judge — whichever makes sense), and prints a table.
